...
Second derivative of rotation assuming a single motor. Arm ![](https://render.githubusercontent.com/render/math?math=\underrightarrow{r_F}) originates from drone center of gravity. ![](https://render.githubusercontent.com/render/math?math=I) is the diagonal intertia tensor of the drone.
...
Because ![](https://render.githubusercontent.com/render/math?math=\ddot{\underrightarrow{\theta}}) is contant, integration is straightforward.
...
Derive angle ![](https://render.githubusercontent.com/render/math?math=\theta).
...
Rotational axis ![](https://render.githubusercontent.com/render/math?math=e).
...
Velocity of drone. ![](https://render.githubusercontent.com/render/math?math=\alpha) has been split in the three operands of addition, because their integrals can be found seperately.

![](https://render.githubusercontent.com/render/math?math=\color{%23666}%20\large%20\underrightarrow{v}=\frac{1}{m}\int%20\underrightarrow{a}(t)%2B\underrightarrow{b}(t)%2B\underrightarrow{c}(t)dt)
